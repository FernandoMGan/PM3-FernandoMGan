// File C:\Home\Developing\PM3-FernandoMGan\front\src\views\LoguinSingCall.jsx

import React, { useState, useEffect } from 'react';
import { Link } from 'react-router-dom';
import CompanyLogo from '../assets/company/CompanyLogo.svg';
import styles from '../components/LoguinSingCall.module.css';
...
const LoguinSignUp = () => {
    ...
    const handleOnSubmit = (event) => {
        ...
        alert(`Pasando por el aceptar del form Up`)
                ...
                <div className="container text-center" id="cntd-ppal">
                    ...
                    <div className="formLoguinButton">
                        <div className="formLoguinButton" style={{ display: 'flex', justifyContent: 'space-between' }}>
                            <Link to="/">
                                <input type="button" value="ACEPTAR" className="secundary-button login-button" id="btnFormOk" onClick={handleOnSubmit} />
                            </Link>
                            <Link to="/">
                                <input type="button" value="CANCELAR" className="secundary-button login-button" id="btnFormCancel" />
                            </Link>
